...
export async function createLabel(gmail: any, labelName: string, options: any = {}) {
  try {
...
export async function updateLabel(gmail: any, labelId: string, updates: any) {
  try {
...
export async function listLabels(gmail: any) {
  try {
    ...
    const systemLabels = labels.filter((label: any) => label.type === 'system');
...
export async function getOrCreateLabel(gmail: any, labelName: string, options: any = {}) {
  try {
